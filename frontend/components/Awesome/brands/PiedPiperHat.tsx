...
const SvgPiedPiperHat = (props: React.SVGProps<SVGSVGElement>) => (
...
SvgPiedPiperHat.displayName = "SvgPiedPiperHat";
SvgPiedPiperHat.defaultProps = {
  width: 24,
  height: 24,
  fill: "currentcolor",
};
export default SvgPiedPiperHat;
