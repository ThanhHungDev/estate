...
const SvgCreativeCommonsPdAlt = (props: React.SVGProps<SVGSVGElement>) => (
...
SvgCreativeCommonsPdAlt.displayName = "SvgCreativeCommonsPdAlt";
SvgCreativeCommonsPdAlt.defaultProps = {
  width: 24,
  height: 24,
  fill: "currentcolor",
};
