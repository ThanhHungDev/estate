...
const SvgPiedPiperSquare = (props: React.SVGProps<SVGSVGElement>) => (
...
SvgPiedPiperSquare.displayName = "SvgPiedPiperSquare";
SvgPiedPiperSquare.defaultProps = {
  width: 24,
  height: 24,
  fill: "currentcolor",
};
export default SvgPiedPiperSquare;
