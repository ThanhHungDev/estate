...
const SvgAcquisitionsIncorporated = (props: React.SVGProps<SVGSVGElement>) => (
...
SvgAcquisitionsIncorporated.displayName = "SvgAcquisitionsIncorporated";
SvgAcquisitionsIncorporated.defaultProps = {
  width: 24,
  height: 24,
  fill: "currentcolor",
};
