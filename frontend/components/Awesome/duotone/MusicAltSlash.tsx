...
const SvgMusicAltSlash = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 640 512" {...props}>
    <path
      d="M272 352c-61.86 0-112 35.82-112 80s50.14 80 112 80 112-35.82 112-80v-5.18l-94.92-73.36A143.68 143.68 0 00272 352zM438.94 1.33L342.4 29.84a32 32 0 00-22.4 30.5v155.22L384 265V148.15l73-21.39a32 32 0 0023-30.71V32a32 32 0 00-41.06-30.67z"
      opacity={0.4}
    />
    <path
      ...
      className="music-alt-slash_svg__fa-primary"
    />
  </svg>
);
