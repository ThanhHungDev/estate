...
const SvgArrowAltFromBottom = (props: React.SVGProps<SVGSVGElement>) => (
...
SvgArrowAltFromBottom.displayName = "SvgArrowAltFromBottom";
SvgArrowAltFromBottom.defaultProps = {
  width: 24,
  height: 24,
  fill: "currentcolor",
};
