...
const SvgParkingCircleSlash = (props: React.SVGProps<SVGSVGElement>) => (
...
SvgParkingCircleSlash.displayName = "SvgParkingCircleSlash";
SvgParkingCircleSlash.defaultProps = {
  width: 24,
  height: 24,
  fill: "currentcolor",
};
