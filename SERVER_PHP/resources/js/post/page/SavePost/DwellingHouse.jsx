...
import Info from "./DwellingHouse/Info"
...
function DwellingHouse( props ){
    ...
    const continueStep = (childData) => {
        ...
        if( SW.currentStep == 1 ){
            ...
            const apartmentInfo = refInfRealEstate.current.validateFromStep()
            if( apartmentInfo ){
        ...
        <div className="apartment" style={{ minHeight: device.calcHeightSubtractHeight + "px" }}>
            ...
            <div className={ "apartment__wrapper " + ( progress && 'd-none') }>
                ...
                >
                    ...
                    <Info ref={ refInfRealEstate }  CONFIG={CONFIG} AUTH={AUTH} OLD={form} />
...
export default connect(mapStateToProps)(DwellingHouse)