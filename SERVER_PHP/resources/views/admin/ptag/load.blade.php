...
@section('page_title', 'danh sách ptag')

@section('content_admin')
<div class="page__ptag-load admin-main-content">
        ...
        <div class="col-12 bg-white shadows-1 px-3 py-3 table-list">
            ...
            <div class="row trow-list">
                <div class="col-1 trow_list__wrapper_image">
                    <img class="item_image" src="{{ $ptag->background }}" />
                </div>
                <div class="col-3">
                    <a href="{{ Route("ADMIN_STORE_PTAG", ['id' =>  $ptag->id]) }}">
                        {{ $ptag->getName(30) }}
                    </a>
                </div>
                <div class="col-7">{{ $ptag->getDescriptionSeo(120) }}</div>
                <div class="col-1">
                    <button type="button"
                    onclick="deleteComponent('{{ $ptag->id }}', this)"
            ...
            <div class="pagi">
                {{ $ptags->onEachSide(3)->links("pagination::default") }}
            </div>
