...
@section('javascripts')
    ...
    <script src="{{ asset('js/admin/validate.rating.min.js') }}"></script>
...
@section('page_title', $rating->id ? 'chỉnh sửa rating' : 'thêm mới rating')

@section('content_admin')
<div class="page__rating admin-main-content">
    <div class="row">
        <div class="col-12">
                ...
                <div class="col-12 bg-color-white shadows-1 px-3 py-3">
                    ...
                    <div class="position-relative wrapper__selectImageWithCKFinder type-select-ckfinder__inline">
                        <input name="avatar" class="img__outputCKFinder jquery__append-out" type="text" 
                            value="{{ old('avatar', $rating->avatar) }}" 
