...
@section('content')
                    ...
                    <div class="tz-breadcrumb-navxt" itemscope itemtype="https://schema.org/BreadcrumbList">
                        ...
                        <span itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                            <a itemprop="item"  title="{{ Config::get('app.name') }}"
                                ...
                                <span itemprop="name"> {{ $post->topic->name }} </span>
                            </a>
                        ...
                        <span itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                            <a itemprop="item"  title="{{ Config::get('app.name') }}"
                                href="{{ Route('POST_VIEW', ['slug' => $post->slug]) }}" class="post post-property current-item">
                                <span itemprop="name"> {{ $post->title }} </span>
                            </a>
                            <meta property="url" content="{{ Route('POST_VIEW', ['slug' => $post->slug]) }}">
    ...
    <div class="content__product product bg__product--detail" itemscope itemtype="https://schema.org/Article">
        ...
        <div class="d-none" itemprop="aggregateRating" itemtype="https://schema.org/AggregateRating" itemscope>
            <meta itemprop="reviewCount" content="{{ SupportString::createRateValueByDate($post->id) }}" />
            <meta itemprop="ratingValue" content="{{ $post->rate_value }}" />
            <meta itemprop="bestRating" content="5" />
            <meta itemprop="worstRating" content="1" />
        </div>
        
        <div class="d-none" itemprop="review" itemtype="https://schema.org/Review" itemscope>
            <meta itemprop="datePublished" content="{{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $post->created_at)->format('Y-m-d') }}" />
            <meta itemprop="reviewBody" content="{{ $post->rate_review_body }}" />
            <div itemprop="author" itemtype="https://schema.org/Person" itemscope>
                <meta itemprop="name" content="{{ $post->rateAuthor ? $post->rateAuthor->name : 'chưa xác định' }}" />
            </div>
            <div itemprop="reviewRating" itemtype="https://schema.org/Rating" itemscope>
                <meta itemprop="ratingCount" content="{{ SupportString::createRateValueByDate($post->id) }}" />
                <meta itemprop="bestRating" content="5" />
                <meta itemprop="worstRating" content="1" />
                <meta itemprop="ratingValue" content="{{ $post->rate_value }}" />
            </div>
            ...
            <div class="product__row py-3">
                <div class="product__left">
                    <div class="product__title">
                        <h2 class="product__title--negotive" itemprop="name">
                            ...
                            <span class="for-negotive ">
                                {{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $post->created_at)->isWeekday() ? 'Mới trong tuần' : null }}
                            </span>
                        </h2>
                    ...
                    <div class="product__information">
                        ...
                        <div class="product__information--datepublished">
                            ...
                            <span class="text" itemprop="datePublished" >{{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $post->created_at)->format('Y-m-d') }}</span>
                        </div>
                        <div class="product__information--view">
                            <i class="fal fa-eye"></i>
                            <span class="text">{{ $post->view }} lượt xem</span>
                        </div>
                    </div>
                    ...
                    <div class="product__data">
                        ...
                        <div class="block">
                            <h3 class="block__title"> Bất Động Sản mới  </h3>
                ...
                <div class="product__right">
                    ...
                    <aside class="categories">
                        <h3 class="category__title">Chủ đề của bài viết</h3>
                        <ul>
                            @foreach ($topics as $key => $topic)
                            <li class="category__title-item">
                                <a class="text-truncate" href="{{ Route('TOPIC_VIEW', ['slug' => $topic->slug ]) }}">{{ $topic->name }}</a>
                            </li>
                            @endforeach
                        </ul>
                    </aside>
