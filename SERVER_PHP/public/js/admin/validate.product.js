...
/*!************************************************!*\
  !*** ./resources/admin/js/validate.product.js ***!
  \************************************************/
  ...
  formJquery.validate({
    ...
    messages: {
      ...
      name: {
        ...
        maxlength: "tên có độ dài lớn nhất là {0}"
      },
      slug: {
      ...
      commune_id: {
        required: "bắt buộc nhập vị trí ( chọn quận/ huyện trước)",
        select2Min1: "vị trí chưa chính xác"
      },
      rate_value: {
        number: "bắt buộc nhập số",
        min: "đánh giá không nên nhỏ hơn {0}",
...
jQuery.validator.addMethod('select2Min1', function (value, element) {
