...
/*!**********************************!*\
  !*** ./resources/js/login.fb.js ***!
  \**********************************/
window.fbAsyncInit = function () {
  // FB JavaScript SDK configuration and setup
  FB.init({
    appId: '283050503736872',
    // FB App ID
    cookie: true,
  ...
  FB.getLoginStatus(function (response) {
    console.log(response, "luôn chạy hàm này mặc định để xác định user login chưa"); // connected => Người dùng đăng nhập Facebook và đã đăng nhập trang web của bạn.
...
})(document, 'script', 'facebook-jssdk'); // Facebook login with JavaScript SDK
...
function getFbUserData() {
  FB.api('/me', {
    ...
    console.log(response, "đăng nhập fb thành công"); // response.picture.data.url
