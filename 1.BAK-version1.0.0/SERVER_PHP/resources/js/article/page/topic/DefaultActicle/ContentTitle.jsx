...
import V from "../../../validator/title-content"
Validator.setMessages(V.messages)
import fileApi from '../../../../service/file.api'
import editorHelper from "../../../../service/editor.helper"
...
const ContentTitle = forwardRef((props, ref) => {
    ...
    const handlePastedText = (text, html, editorState) => {
        console.log("sdfdsfds fds handlePastedText")
    ...
    const uploadCallback = file => {
        console.log(",có vào uploadCallback")
        ...
        () => ({
            validateFromStep(){
                ...
                if( errors.hasError ){
                    ...
                    return {
                        ...values,
                        images: editorHelper.getEntitiesData(editorState, 'IMAGE')
                    }
                }
            }
        }),
                    ...
                    <div className="col-12">
                        <div className="form-group required">
                            ...
                            <div
                                ...
                                <Editor
                                    customDecorators={ [ { strategy: editorHelper.findImageEntities, component: editorHelper.Image, }, ] }
