                ...
                <div class="container">
                    ...
                    <div class="tz-breadcrumb-navxt" itemscope itemtype="https://schema.org/BreadcrumbList">
                        ...
                        @foreach ($categories as $key => $value )
                            <span itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                                <a itemprop="item"
                                    title="{{ $value->name }}" href="{{ Route('CATEGORY_VIEW', ['slug' => $value->slug ]) }}"
                        ...
                        <span itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                            <a itemprop="item"  title="{{ Config::get('app.name') }}"
                                href="{{ Route('CATEGORY_VIEW', ['slug' => $category->slug ]) }}" class="post post-property current-item">
                                <span itemprop="name"> {{ $category->name }} </span>
                            </a>
                            <meta property="url" content="{{ Route('CATEGORY_VIEW', ['slug' => $category->slug]) }}">
                ...
                <div class="product__left">
                    ...
                    <div class="product__information">
                        ...
                        <div class="product__information--datepublished">
                            ...
                            <span class="text" itemprop="datePublished" >{{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $category->created_at)->format('Y-m-d') }}</span>
                        </div>
                    </div>
                    ...
                    <div class="product__data">
                        ...
                        <div class="block">
                            <h3 class="block__title"> Bài đăng Trong Chủ Đề </h3>
                    ...
                    <div class="product__data">
                        ...
                        <div class="block">
                            <h3 class="block__title"> Bài Đăng liên quan </h3>
                            <div class="productions px-0 py-0">
                                <div class="row-hero productions-fixrow">
